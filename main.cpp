...
This code creates a Binary Search Tree that organizes data
The user can add, delete, or search for numbers, print the tree, or end the program
Worked with Jazveer Kaler and got help from Vikram Vasudevan and Taaha Khan
GeeksForGeeks and YouTube were very useful for this project
 */  
